...
<center><font size="7" ><b>매장 관리</b></font>
    <table width="800">
       <tr><td align="left">
           <a href="ms_InsertForm.action?currentPage=${currentPage}">매장 등록</a></td></tr>
    </table>
    
    <table width="800"  border="1" bgcolor=#E6FFFF>
    ...
    <c:forEach var="list"  items="${list}"> <%--매장 목록 뽑아내는 forEach문 --%>
      <tr height="30" bgcolor="">
       ...
       <td align="center" width="600">
          <a href='ms_ViewAction.action?no=${list.no}&currentPage=${currentPage}'>${list.store}</a>
       </td>
