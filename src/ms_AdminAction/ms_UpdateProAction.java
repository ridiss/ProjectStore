...
public class ms_UpdateProAction  implements StoreDAOAware,Action, Preparable, ModelDriven{
	...
	public String execute() throws Exception{
		...
		msDTO.setSreg_Date(today.getTime());
		sqlMapper.update("ms_UpdateStore", msDTO);
		msDTO = (ms_AdminDTO)sqlMapper.queryForObject("ms_SelectOne", msDTO.getNo()); //수정이 끝나면 view페이지로 이동
